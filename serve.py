...
EMBEDDING_MODEL = os.getenv('EMBEDDING_MODEL') or 'sentence-transformers/all-MiniLM-L12-v2'
...
rag = RAG(
    ...
    embeddingName='sentence-transformers/all-MiniLM-L12-v2',
    llm=llm,
)
...
def handle_query():
    ...
    if guidedRoute == PRODUCT_ROUTE_NAME:
        ...
        combined_information = f"Become a sales consultant for a phone store. Customer's question: {query}\nAnswer the question based on the following product information: {source_information}."
